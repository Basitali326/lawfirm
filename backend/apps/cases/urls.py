...
from .views import CaseViewSet, TrashView, GenerateTasksAPIView, CaseBillingSummaryAPIView
...
urlpatterns = router.urls + [
    ...
    path("cases/<uuid:case_id>/billing-summary/", CaseBillingSummaryAPIView.as_view(), name="case-billing-summary"),
